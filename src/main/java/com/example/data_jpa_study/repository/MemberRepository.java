...
public interface MemberRepository extends JpaRepository<Member,Long>, MemberRepositoryCustom{
    ...
    @Query(value = "select m.member_id as id, m.username, t.name as teamName from member m left join team t on m.team_id =  t.team_id",countQuery = "select count(m) from member", nativeQuery = true)
